...
_start:
    ...
    ; Debugging: print raw input to verify input is captured correctly
    mov rax, 1                    ; Syscall number for write
    mov rdi, 1                    ; File descriptor (stdout)
    mov rsi, buffer               ; Pointer to buffer
    mov rdx, 100                  ; Max number of bytes to read
...
reverse_array:
    ...
    mov rdx, rcx                  ; Set rdx to the number of valid elements in the array
    dec rdx                        ; Set rdx to array length - 1
.reverse_loop:
