...
section .bss
    arr resd 5                    ; Reserve space for 5 integers (4 bytes each)
...
_start:
    ...
    mov rdx, 20                   ; Read up to 20 bytes (5 integers * 4 bytes each)
    syscall
...
reverse_array:
    mov rcx, 2                    ; Number of swaps (5 / 2 = 2)
.reverse_loop:
...
section .bss
    buffer resb 20                ; Buffer for ASCII representation
