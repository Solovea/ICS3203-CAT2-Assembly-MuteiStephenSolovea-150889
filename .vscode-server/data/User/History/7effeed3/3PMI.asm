section .data
    ...
    error_msg db "Error: Invalid input or overflow.", 0xA, 0
...
_start:
    ...
    jz .error                    ; Jump to error if invalid
    ...
    mov rsi, rdi                 ; Update RDI to the ASCII string start
    mov rdx, buffer + 19 - rdi   ; Length of the number
    mov rax, 1                   ; Syscall: write
    mov rdi, 1                   ; File descriptor: stdout
    syscall
